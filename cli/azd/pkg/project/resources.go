...
type AppServiceRuntimeType string

const (
	AppServiceRuntimeTypePython AppServiceRuntimeType = "python"
	AppServiceRuntimeTypeNode   AppServiceRuntimeType = "node"
)

func (r AppServiceRuntimeType) String() string {
	switch r {
	case AppServiceRuntimeTypePython:
		return "Python"
	case AppServiceRuntimeTypeNode:
		return "Node"
	}
	return string(r)
}
...
type AppServiceRuntime struct {
	Type    AppServiceRuntimeType `yaml:"type,omitempty"`
