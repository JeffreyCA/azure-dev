...
const (
	...
	PromptService_PromptAiLocation_FullMethodName            = "/azdext.PromptService/PromptAiLocation"
...
type PromptServiceClient interface {
	...
	PromptAiLocation(ctx context.Context, in *PromptAiLocationRequest, opts ...grpc.CallOption) (*PromptAiLocationResponse, error)
...
func (c *promptServiceClient) PromptAiLocation(ctx context.Context, in *PromptAiLocationRequest, opts ...grpc.CallOption) (*PromptAiLocationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PromptAiLocationResponse)
	err := c.cc.Invoke(ctx, PromptService_PromptAiLocation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *promptServiceClient) PromptAiDeployment(ctx context.Context, in *PromptAiDeploymentRequest, opts ...grpc.CallOption) (*PromptAiDeploymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PromptAiDeploymentResponse)
	err := c.cc.Invoke(ctx, PromptService_PromptAiDeployment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PromptServiceServer interface {
	...
	// PromptAiLocation prompts the user to select a location that can satisfy AI quota requirements.
	PromptAiLocation(context.Context, *PromptAiLocationRequest) (*PromptAiLocationResponse, error)
	// PromptAiModel prompts the user to select an AI model deployment candidate from a location.
...
func (UnimplementedPromptServiceServer) PromptAiLocation(context.Context, *PromptAiLocationRequest) (*PromptAiLocationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PromptAiLocation not implemented")
}
...
func _PromptService_PromptAiLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PromptAiLocationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PromptServiceServer).PromptAiLocation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PromptService_PromptAiLocation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PromptServiceServer).PromptAiLocation(ctx, req.(*PromptAiLocationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PromptService_PromptAiDeployment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PromptAiDeploymentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PromptServiceServer).PromptAiDeployment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PromptService_PromptAiDeployment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PromptServiceServer).PromptAiDeployment(ctx, req.(*PromptAiDeploymentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PromptService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PromptAiLocation",
			Handler:    _PromptService_PromptAiLocation_Handler,
		},
		{
